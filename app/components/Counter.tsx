        ...
        <Container>
          <div className="grid grid-cols-4">
            <div className="text-center flex items-center justify-center flex-col">
              ...
              <p className="text-xl font-semibold">Icon Collections</p>
            </div>
            <div className="text-center flex items-center justify-center flex-col">
              ...
              <p className="text-xl font-semibold">Masonry Layouts</p>
            </div>
            <div className="text-center flex items-center justify-center flex-col">
              ...
              <p className="text-xl font-semibold">Only The Best</p>
            </div>
            <div className="text-center flex items-center justify-center flex-col">
              ...
              <p className="text-xl font-semibold">Elated Design</p>
            </div>
          </div>
        </Container>
      </div>
